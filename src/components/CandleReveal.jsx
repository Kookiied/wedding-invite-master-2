...
export default function CandleReveal() {
  ...
  return (
    <section 
      ref={sectionRef}
      className="relative w-full py-20 flex flex-col items-center justify-center bg-gradient-to-b from-[#1A030D] via-[#2A0412] to-[#1A030D] text-center border-t border-[#E6A4B4]/30 overflow-hidden"
    >
      ...
      >
        ...
        <h2 className="font-serif text-3xl sm:text-4xl text-[#F8C8DC] mb-3 tracking-wide">
          Make a Wish
        </h2>
        ...
        {isLit ? (
          <motion.div 
            ...
            className="mb-8 bg-[#3D061A]/90 border border-[#E6A4B4]/50 text-[#F8C8DC] text-xs font-serif px-5 py-2 rounded-full shadow-[0_0_20px_rgba(230,164,180,0.4)] flex items-center gap-2"
          >
            <Wind className="w-4 h-4 text-[#FFD700]" />
            <span>Blow air toward camera to extinguish flame</span>
          </motion.div>
        ) : (
          <div className="mb-8 bg-emerald-950/80 border border-emerald-500/50 text-emerald-300 text-xs font-serif px-5 py-2 rounded-full flex items-center gap-2 shadow-[0_0_20px_rgba(16,185,129,0.3)]">
        ...
        <AnimatePresence>
          {!isLit && (
            <motion.div 
              ...
              className="w-full bg-gradient-to-b from-[#3D061A] to-[#2A0412] border-2 border-[#FFD700]/80 p-6 sm:p-8 rounded-3xl shadow-[0_0_50px_rgba(255,215,0,0.4)] z-30 text-center relative overflow-hidden"
            >
              ...
              <h3 className="font-serif text-2xl text-[#FFD700] mb-3">
                Thank You for Your Blessings
              </h3>
              
              <p className="font-serif text-sm sm:text-base text-[#FFF0F5] italic leading-relaxed mb-4">
                "Your presence, love, and warm wishes light up our lives as we step into this beautiful new chapter together."
              </p>

              <div className="text-[11px] font-sans uppercase tracking-widest text-[#E6A4B4] font-semibold">
        ...
        {isLit && (
          <button 
            ...
            className="mt-6 text-[10px] text-[#E6A4B4]/80 uppercase tracking-widest hover:text-[#F8C8DC] transition-colors underline cursor-pointer"
          >
